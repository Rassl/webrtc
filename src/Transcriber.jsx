...
export const Transcriber = ({ onMessageUpdate }) => {
            ...
            <div className="w-[500px] p-2">
              ...
              {status === "ready" && (
                <div className="relative">
                  <p className="w-full h-[180px] overflow-y-auto overflow-wrap-anywhere border rounded-lg p-2">
                    {text}
                  </p>
